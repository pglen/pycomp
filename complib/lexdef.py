...
try:
    ...
    (INI_STATE, "ident",    r"function" + IDEN3,    None, None ),
    (INI_STATE, "func",     r"function",        None, None ),
    (INI_STATE, "ident",    r"func" + IDEN3,    None, None ),
    (INI_STATE, "func",     r"func",            None, None ),
    (INI_STATE, "ident",    r"break" + IDEN3,   None, None ),
    (INI_STATE, "break",    r"break",           None, None ),
    (INI_STATE, "ident",    r"enter" + IDEN3,   None, None ),
    (INI_STATE, "enter",    r"enter",           None, None ),
    (INI_STATE, "ident",    r"leave" + IDEN3,   None, None ),
    (INI_STATE, "leave",    r"leave",           None, None ),
    (INI_STATE, "ident",    r"return" + IDEN3,  None, None ),
    (INI_STATE, "return",   r"return" ,         None, None ),
    (INI_STATE, "ident",    r"loop" + IDEN3,    None, None ),
    ...
    (INI_STATE, "quote",    r"\""   ,           STR_STATE, None),
    ...
    # We parse white spaces, the parser deal with it
