...
class calcParser ( Parser ):
    ...
    class EquationContext(ParserRuleContext):
        ...
        def relop(self):
            return self.getTypedRuleContext(calcParser.RelopContext,0)
    ...
    class ExpressionContext(ParserRuleContext):
        ...
        def multiplyingExpression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(calcParser.MultiplyingExpressionContext)
            else:
                return self.getTypedRuleContext(calcParser.MultiplyingExpressionContext,i)
    ...
    class MultiplyingExpressionContext(ParserRuleContext):
        ...
        def powExpression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(calcParser.PowExpressionContext)
            else:
                return self.getTypedRuleContext(calcParser.PowExpressionContext,i)


        def TIMES(self, i:int=None):
            if i is None:
                return self.getTokens(calcParser.TIMES)
            else:
                return self.getToken(calcParser.TIMES, i)
        ...
        def getRuleIndex(self):
            return calcParser.RULE_multiplyingExpression
    ...
    def multiplyingExpression(self):
        ...
        localctx = calcParser.MultiplyingExpressionContext(self, self._ctx, self.state)
    ...
    class PowExpressionContext(ParserRuleContext):
        ...
        def signedAtom(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(calcParser.SignedAtomContext)
            else:
                return self.getTypedRuleContext(calcParser.SignedAtomContext,i)


        def POW(self, i:int=None):
            if i is None:
                return self.getTokens(calcParser.POW)
            else:
                return self.getToken(calcParser.POW, i)

        def getRuleIndex(self):
            return calcParser.RULE_powExpression
    ...
    def powExpression(self):
        ...
        localctx = calcParser.PowExpressionContext(self, self._ctx, self.state)
    ...
    class SignedAtomContext(ParserRuleContext):
        ...
        def signedAtom(self):
            return self.getTypedRuleContext(calcParser.SignedAtomContext,0)


        def MINUS(self):
            return self.getToken(calcParser.MINUS, 0)

        def func_(self):
            return self.getTypedRuleContext(calcParser.Func_Context,0)
        ...
        def getRuleIndex(self):
            return calcParser.RULE_signedAtom
    ...
    def signedAtom(self):
        ...
        localctx = calcParser.SignedAtomContext(self, self._ctx, self.state)
    ...
    class AtomContext(ParserRuleContext):
        ...
        def scientific(self):
            return self.getTypedRuleContext(calcParser.ScientificContext,0)


        def variable(self):
            return self.getTypedRuleContext(calcParser.VariableContext,0)


        def constant(self):
            return self.getTypedRuleContext(calcParser.ConstantContext,0)
    ...
    class ScientificContext(ParserRuleContext):
        ...
        def SCIENTIFIC_NUMBER(self):
            return self.getToken(calcParser.SCIENTIFIC_NUMBER, 0)

        def getRuleIndex(self):
            return calcParser.RULE_scientific
    ...
    def scientific(self):
        ...
        localctx = calcParser.ScientificContext(self, self._ctx, self.state)
        self.enterRule(localctx, 12, self.RULE_scientific)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 70
            self.match(calcParser.SCIENTIFIC_NUMBER)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class ConstantContext(ParserRuleContext):
        ...
        def PI(self):
            return self.getToken(calcParser.PI, 0)

        def EULER(self):
            return self.getToken(calcParser.EULER, 0)

        def I(self):
            return self.getToken(calcParser.I, 0)
    ...
    def constant(self):
        ...
        localctx = calcParser.ConstantContext(self, self._ctx, self.state)
    ...
    class VariableContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return calcParser.RULE_variable
    ...
    def variable(self):
        ...
        localctx = calcParser.VariableContext(self, self._ctx, self.state)
    ...
    class Func_Context(ParserRuleContext):
        ...
        def funcname(self):
            return self.getTypedRuleContext(calcParser.FuncnameContext,0)
        ...
        def COMMA(self, i:int=None):
            if i is None:
                return self.getTokens(calcParser.COMMA)
            else:
                return self.getToken(calcParser.COMMA, i)

        def getRuleIndex(self):
            return calcParser.RULE_func_
    ...
    def func_(self):
        ...
        localctx = calcParser.Func_Context(self, self._ctx, self.state)
    ...
    class FuncnameContext(ParserRuleContext):
        ...
        def COS(self):
            return self.getToken(calcParser.COS, 0)

        def TAN(self):
            return self.getToken(calcParser.TAN, 0)

        def SIN(self):
            return self.getToken(calcParser.SIN, 0)

        def ACOS(self):
            return self.getToken(calcParser.ACOS, 0)

        def ATAN(self):
            return self.getToken(calcParser.ATAN, 0)

        def ASIN(self):
            return self.getToken(calcParser.ASIN, 0)

        def LOG(self):
            return self.getToken(calcParser.LOG, 0)

        def LN(self):
            return self.getToken(calcParser.LN, 0)

        def SQRT(self):
            return self.getToken(calcParser.SQRT, 0)

        def getRuleIndex(self):
            return calcParser.RULE_funcname
    ...
    def funcname(self):
        ...
        localctx = calcParser.FuncnameContext(self, self._ctx, self.state)
    ...
    class RelopContext(ParserRuleContext):
        ...
        def GT(self):
            return self.getToken(calcParser.GT, 0)

        def LT(self):
            return self.getToken(calcParser.LT, 0)

        def getRuleIndex(self):
            return calcParser.RULE_relop
    ...
    def relop(self):
        ...
        localctx = calcParser.RelopContext(self, self._ctx, self.state)
