...
class ExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExprParser#assn.
    def enterAssn(self, ctx:ExprParser.AssnContext):
        pass

    # Exit a parse tree produced by ExprParser#assn.
    def exitAssn(self, ctx:ExprParser.AssnContext):
        pass
